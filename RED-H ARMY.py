...
os.system('xdg-open https://www.youtube.com/@TaChUcHhA-oz2vo/')
...
logo=("""\x1b[1;92m
  ___ ___ ___      _  _     _   ___ __  ____   __
 | _ \ __|   \ ___| || |   /_\ | _ \  \/  \ \ / /
 |   / _|| |) |___| __ |  / _ \|   / |\/| |\ V / 
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system(f'xdg-open https://www.youtube.com/@TaChUcHhA-oz2vo/{wx}');menu()
                        elif xd in ['7','07']:
                                os.system('xdg-open https://www.youtube.com/@TaChUcHhA-oz2vo');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://www.youtube.com/@TaChUcHhA-oz2vo');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+923163805153 I &text="
